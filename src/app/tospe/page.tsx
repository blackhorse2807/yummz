    ...
    <div className="bg-gradient-to-b from-[#faf9f6] to-white">
      ...
      <div className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <h1 className="text-9xl sm:text-8xl font-bold text-white drop-shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Image src="/images/leechang1.jpg" alt="TOSPE Logo" width={400} height={300} className="rounded-lg" />
          <Image src="/images/leechang2.jpg" alt="Gallery Image 1" width={500} height={500} className="rounded-lg" />
          <Image src="/images/leechang4.jpg" alt="Gallery Image 2" width={400} height={300} className="rounded-lg" />
          <Image src="/images/leechang5.jpeg" alt="Gallery Image 3" width={400} height={300} className="rounded-lg" />
