    ...
    <div className="bg-gradient-to-b from-[#faf9f6] to-white">
      ...
      <div className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <h1 className="text-9xl sm:text-5xl font-bold text-white tracking-tight">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div variants={fadeIn} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-6">
              <h3 className="text-xl font-medium text-[#1a2a44]">Premium Egg Noodles</h3>
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className="text-[#1a2a44] font-medium">Available in: 200g, 500g</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeIn} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-6">
              <h3 className="text-xl font-medium text-[#1a2a44]">Premium Soy Sauce</h3>
              <p className="mt-2 text-[#1a2a44]/80 text-justify">
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className="text-[#1a2a44] font-medium">Available in: 250ml, 500ml, 1L</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeIn} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="p-6">
              <h3 className="text-xl font-medium text-[#1a2a44]">Signature Stir-Fry Sauce</h3>
              <p className="mt-2 text-[#1a2a44]/80 text-justify">
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className="text-[#1a2a44] font-medium">Available in: 250ml, 500ml</span>
              </div>
            </div>
          </motion.div>
        </div>
            ...
            <div className="order-2 md:order-1">
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <h4 className="text-[#1a2a44] font-medium mb-2">Kung Pao Chicken</h4>
                  <p className="text-[#1a2a44]/80 text-sm">Ready in 15 minutes</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <h4 className="text-[#1a2a44] font-medium mb-2">Mongolian Beef</h4>
                  <p className="text-[#1a2a44]/80 text-sm">Ready in 20 minutes</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <h4 className="text-[#1a2a44] font-medium mb-2">Vegetable Stir-Fry</h4>
                  <p className="text-[#1a2a44]/80 text-sm">Ready in 10 minutes</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <h4 className="text-[#1a2a44] font-medium mb-2">Sweet & Sour Pork</h4>
                  <p className="text-[#1a2a44]/80 text-sm">Ready in 18 minutes</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2 relative h-96 rounded-xl overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent">
                <div className="absolute bottom-0 left-0 p-8">
                  <p className="text-white text-lg font-semibold">Premium ready-to-cook meal kits for authentic Asian cuisine</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-[#1a2a44]/10 hover:shadow-2xl transition-shadow duration-300">
            <div className="text-[#1a2a44] mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <h3 className="text-xl font-medium mb-4 text-[#1a2a44]">Premium Ingredients</h3>
            <p className="text-[#1a2a44]/80 text-justify">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-[#1a2a44]/10 hover:shadow-2xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-medium mb-4 text-[#1a2a44]">Authentic Recipes</h3>
            <p className="text-[#1a2a44]/80 text-justify">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-[#1a2a44]/10 hover:shadow-2xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-medium mb-4 text-[#1a2a44]">Quality Assurance</h3>
            <p className="text-[#1a2a44]/80 text-justify">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Image src="/infographics/leechang-sauce.jpg" alt="Lee-Chang 1" width={400} height={300} className="rounded-lg" />
          <Image src="/infographics/mixed-pickle.jpg" alt="Lee-Chang 2" width={400} height={300} className="rounded-lg" />
          <Image src="/infographics/sause.jpg" alt="Lee-Chang 4" width={400} height={300} className="rounded-lg" />
          <Image src="/infographics/sweet-corn-canned.jpg" alt="Lee-Chang 5" width={400} height={300} className="rounded-lg" />
          <Image src="/infographics/green-chili-sauce.jpg" alt="Lee-Chang Logo" width={400} height={300} className="rounded-lg" />
