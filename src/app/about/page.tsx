...
export default function AboutPage() {
  ...
  return (
    <div className=" bg-white text-justify">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-1 bg-amber-400"></div>
              <h1 className="mt-8 text-5xl sm:text-6xl font-serif font-bold text-white tracking-tight">
                About <span className="text-amber-400">YUMMZ</span>
              </h1>
              <p className="mt-6 text-xl text-amber-50 max-w-2xl mx-auto font-light leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        <div className="bg-white rounded-xl shadow-2xl p-8 sm:p-12 border border-amber-50">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-2xl font-serif text-amber-800">Est. 1920</h2>
            <p className="mt-6 text-lg text-amber-700 leading-relaxed font-light">
            ...
            <div className="mt-8 flex justify-center">
              <div className="inline-flex items-center">
                ...
                <svg className="h-5 w-5 mx-3 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-block">
              <h2 className="text-3xl font-serif font-bold text-amber-800 mb-2">Our Heritage</h2>
      ...
      <div className="mt-32 py-24 bg-amber-50">
        <motion.div 
          initial="initial"
          whileInView="animate"
          viewport={{ once: true }}
        ...
        >
          <div className="text-center mb-16">
            <motion.div variants={fadeInUp}>
              <h2 className="text-3xl font-serif font-bold text-amber-800">Our Guiding Principles</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <motion.div 
              variants={fadeInUp}
              className="bg-white p-12 rounded-2xl shadow-xl border border-amber-100 hover:shadow-2xl transition-shadow duration-300"
            >
              <div className="flex justify-center mb-6">
                <div className="text-amber-500 bg-amber-50 p-5 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
              </div>
              <h3 className="text-2xl font-serif font-bold text-amber-800 text-center mb-6">Our Mission</h3>
              <p className="text-amber-700 text-center leading-relaxed font-light">
            ...
            >
              ...
              <h3 className="text-2xl font-serif font-bold text-amber-800 text-center mb-6">Our Vision</h3>
              <p className="text-amber-700 text-center leading-relaxed font-light">
      ...
      >
        <div className="text-center mb-20">
          <motion.div variants={fadeInUp}>
            <h2 className="text-3xl font-serif font-bold text-amber-800">Why Choose YUMMZ FOODS?</h2>
            <div className="h-1 w-24 bg-gradient-to-r from-amber-300 to-amber-500 mx-auto mt-4"></div>
            <p className="mt-6 text-amber-700 max-w-3xl mx-auto font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <motion.div 
            variants={fadeInUp}
            className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-amber-50 hover:border-amber-200"
          >
            <div className="text-amber-500 bg-amber-50 p-4 rounded-xl inline-block mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <h3 className="text-xl font-medium mb-3 text-amber-800">Century-old Legacy</h3>
            <p className="text-amber-700 font-light leading-relaxed">Our four-generation heritage in food commerce brings unparalleled expertise and time-tested methods to every product we create.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-3 text-amber-800">Scientific Approach</h3>
            <p className="text-amber-700 font-light leading-relaxed">Led by a Bio-Science graduate, we combine traditional knowledge with scientific principles for optimal flavor, nutrition, and safety.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-3 text-amber-800">Local Sourcing</h3>
            <p className="text-amber-700 font-light leading-relaxed">We source most raw materials within a 50km radius, ensuring freshness while supporting local farmers and reducing our carbon footprint.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-3 text-amber-800">ISO 22000:2005 Certified</h3>
            <p className="text-amber-700 font-light leading-relaxed">Our stringent quality management systems ensure food safety and consistency at every stage of processing, packaging, and distribution.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-3 text-amber-800">Diverse Experience</h3>
            <p className="text-amber-700 font-light leading-relaxed">Our expertise spans dairy, goat farming, mushroom cultivation, and medicinal plant extraction – knowledge that enhances our food processing capabilities.</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-medium mb-3 text-amber-800">Integrated Cold Chain</h3>
            <p className="text-amber-700 font-light leading-relaxed">Our 2500 MT multipurpose cold storage with specialized chambers ensures optimal preservation from farm to consumer.</p>
          </motion.div>
        </div>
      </motion.div>
